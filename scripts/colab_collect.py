...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--dtype", default=env("REFLEX_DTYPE", "float32"))
    parser.add_argument("--fault", default=env("REFLEX_FAULT", "healthy"))
    parser.add_argument("--compile", default=env("REFLEX_COMPILE", "0"))
    parser.add_argument("--cudnn-bench", default=env("REFLEX_CUDNN_BENCH", "0"))
    parser.add_argument("--contention", default=env("REFLEX_CONTENTION", "0"))
    parser.add_argument("--compile-mode", default=env("REFLEX_COMPILE_MODE", "default"))
    parser.add_argument("--tf32", default=env("REFLEX_TF32", "1"))
    parser.add_argument("--shards", default=env("REFLEX_SHARDS", "1"))
    parser.add_argument("--streams", default=env("REFLEX_STREAMS", "1"))
    parser.add_argument("--threads", default=env("REFLEX_THREADS", "0"))
    parser.add_argument("--frame-fault", default=env("REFLEX_FRAME_FAULT", "none"))
    parser.add_argument("--instruction-fault",
                        default=env("REFLEX_INSTRUCTION_FAULT", "none"))
