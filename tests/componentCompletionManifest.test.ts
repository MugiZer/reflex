...
describe("Ticket 09 completion artifact",()=>{
  it("completion manifest covers every invariant and outcome exactly once",async()=>{
    ...
    for(const required of ["component-evaluation-sqlite/v1","SHA-256","repeating-metal-c-profile@1.0.0","repeating-c-profile-safety-v1","exact and bounded","replay","corruption",`${evidence.durationMs} ms`,"efb20084c7dd82cf6b79aaa71490372e0b9629a3","P5","P6"])expect(report).toContain(required);
