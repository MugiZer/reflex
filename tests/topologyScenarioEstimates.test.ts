...
const baseRecipe = { schemaVersion: "1.0.0-draft", rows: [{ member: { primitive: { parameters: { width: { value: 0.04, authority: { state: "preliminary-estimate", sourceRefs: ["pack"] } } } } } }] };
...
function widthOf(request: SubmitTopologyAnalysisRequest): number { return (request.recipe as any).rows[0].member.primitive.parameters.width.value; }
