...
export type TopologyPilotRun = { pilotRunId: string; idempotencyKey: string; jobId: string; sourceRevisionId: string; sourceAssemblyGroupId: string; opportunityId: string; disposition: "disabled" | "cohort-excluded" | "killed" | "failed" | "cancelled" | "completed"; policy: TopologyPilotDecision; evaluationId: string | null; aggregateId: string | null; resultIdsHash: string | null; errorCode: string | null; createdAt: string; };
