...
function thermalTreatmentCards(job) {
...
function renderArchitectWorkspace(job, workspace) {
  ...
  app.innerHTML = projectHeader(job, targetU, localProgress) + summaryBar(model.summary, localProgress) + thermalTreatmentCards(job) +
